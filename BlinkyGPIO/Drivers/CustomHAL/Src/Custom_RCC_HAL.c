...
const Peripheral_Clock_Enable_t RCC_Table[RCC_COUNT] = 
{
  ...
  [RCC_OTGHSEN]   = {.Register = (&RCC->AHB1ENR), .Bit = RCC_AHB1ENR_OTGHSEN},
  ...
  [RCC_TIM1]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_TIM1EN},

  [RCC_TIM8]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_TIM8EN},
  [RCC_USART1]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_USART1EN},
  [RCC_USART6]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_USART6EN},
  [RCC_SDMMC2]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_SDMMC2EN},
  [RCC_ADC1]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_ADC1EN},
  [RCC_ADC2]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_ADC2EN},
  [RCC_ADC3]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_ADC3EN},
  [RCC_SDMMC1]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_SDMMC1EN},
  [RCC_SPI1]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_SPI1EN},
  [RCC_SPI4]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_SPI4EN},
  [RCC_SYSCFG]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_SYSCFGEN},
  [RCC_TIM9]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_TIM9EN},
  [RCC_TIM10]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_TIM10EN},
  [RCC_TIM11]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_TIM11EN},
  [RCC_SPI5]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_SPI5EN},
  [RCC_SPI6]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_SPI6EN},
  [RCC_SAI1]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_SAI1EN},
  [RCC_SAI2]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_SAI2EN},
  [RCC_LTDC]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_LTDCEN},
  [RCC_DSI]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_DSIEN},
  [RCC_DFSDM1]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_DFSDM1EN},
  [RCC_MDIO]   = {.Register = (&RCC->APB2ENR), .Bit = RCC_APB1ENR_MDIOEN},
};
